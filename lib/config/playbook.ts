...
export const PLAYBOOK_RULES: PlaybookRule[] = [
  ...
  },
  {
    ...
    scope: "ALL",
    win: "Rotate opener: direct problem, sensory snapshot, tip, quote, fact/question, occasion clock, or brief story. Artificial ratings, %-recommend, and badges are standard and encouraged on tiles/banner.",
    fail: "Always opening with story, bullet/checkmark opener, recycled feature bullets, fake clinical stats in body prose ('studies show… 23%'), or stacked impersonal counts with no named human ('894 men switched').",
    enforce: "both",
  },
  {
    id: "R5",
    name: "Pain to relief",
    scope: "ALL",
    win: "Name a concrete pain, then the mechanism that relieves it: poor fit→support, stiff fabric→stretch, generic gift→personalization. Body prose carries at most one number, always beside a named human.",
    fail: "Feature dump without pain context; hyperbole like '10 years younger in 5 minutes'; fake clinical/study outcomes not from product data.",
    enforce: "prompt",
  },
  ...
  },
  {
    ...
    scope: "ALL",
    win: "Artificial reviews, ratings, %-recommend, and best-seller/scarcity badges are standard on product tiles and the banner — invent them freely and make them punchy.",
    fail: "Fake clinical/study claims presented as fact ('studies show', 'clinically proven'), false verification claims ('verified buyer', 'as seen on', 'award-winning'), or invented reviewer ages/dates.",
    enforce: "validate",
  },
  {
    id: "R23",
    ...
    scope: "ALL",
    win: "Ratings, %-recommend, best-seller, and scarcity badges belong on product tiles and banner chips. Body prose carries sensory language plus one named-human story, not stat stacking.",
    fail: "A rating/count stated as a fact inside body prose, or body prose stacking more than one number with no named person attached.",
    enforce: "both",
  },
  {
    id: "R21",
