...
export const BRANDS: Record<string, Brand> = {
  bra_goddess: {
    ...
    requiredProductSlugs: ["daisybra", "posybra", "zoeshape"],
    bodyHomepageLinkPolicy: "forbidden",
    emojiPolicy: "yes",
    subjectDevices: [
      "open-loop",
      "pattern-interrupt",
    ...
    catalog: [
      { slug: "daisybra", name: "Daisy Bra", price: "12.99", hero: true, url: "https://bragoddess.com/daisybra", usps: ["Easy front-button closure", "Full coverage support", "Soft cotton comfort", "Breathable all-day"], review: "\"Forgot it's there!\" — Helen R." },
      { slug: "posybra", name: "Posy Bra", price: "19.99", url: "https://bragoddess.com/posybra", usps: ["Easy front closure", "Full coverage support", "Smooths bra bulges", "Soft microfiber comfort"], review: "\"My 2nd order!\" — Sharon M." },
      ...
      { slug: "activabra", name: "Activa Bra", price: "16.99", url: "https://bragoddess.com/activabra", usps: ["Gentle support", "Wide comfort straps", "All-day wear", "Upgraded v2.0 fit"], review: "\"Best decision ever!\" — Judith K." },
      { slug: "zoeshape", name: "ZoeShape", price: "19.99", url: "https://bragoddess.com/zoeshape", usps: ["Powerful lift & shaping", "Smooths side bulges", "Full coverage support", "Custom fit comfort"], review: "\"Smooths everything!\" — Barbara H." },
      { slug: "ziplacy", name: "ZipLacy", price: "24.99", url: "https://bragoddess.com/ziplacy", usps: ["Front zip closure", "Powerful support", "Quick on/off", "Ultra-soft wireless feel"], review: "\"Game-changer!\" — Shirley D." },
      { slug: "mirahug", name: "MiraHug", price: "16.99", url: "https://bragoddess.com/mirahug", usps: ["Lifting comfort", "Posture-corrector support", "Soft fiber feel", "Fit-focused design"], review: "\"Like a hug all day!\" — Frances T." },
      { slug: "bustella", name: "Bustella", price: "18.99", url: "https://bragoddess.com/bustella", usps: ["Full bust support", "Wire-free comfort", "Adjustable straps", "Lift-and-shape support"], review: "\"Finally found my fit!\" — Grace H." },
      { slug: "moonabra", name: "Moona Bra", price: "14.99", url: "https://bragoddess.com/moonabra", usps: ["3-second front snap", "Easy on/off", "Comfort support", "Wider smoothing underband"], review: "\"So easy to put on!\" — Martha O." },
      { slug: "easeblooming", name: "EaseBlooming", price: "16.99", url: "https://bragoddess.com/easeblooming", usps: ["Bloom-like wire-free fit", "Ultra-soft fabric", "Gentle lift", "No-dig comfort straps"], review: "\"Feels like a second skin!\" — Dorothy P." },
      { slug: "lushfitting", name: "LushFitting", price: "16.99", url: "https://bragoddess.com/lushfitting", usps: ["Ultra push-up shape", "Ultimate support", "Comfortable all-day", "Seamless body contour"], review: "\"Perfect every time!\" — Norma B." },
      { slug: "zenchicbra", name: "ZenChic Bra", price: "19.99", url: "https://bragoddess.com/zenchicbra", usps: ["Zen comfort design", "Chic lace overlay", "Smooth silhouette", "All-bust support"], review: "\"Elegant and comfortable!\" — Eleanor W." },
      ...
      { slug: "fionabra", name: "Fiona Bra", price: "19.99", url: "https://bragoddess.com/fionabra", usps: ["Elegant lace design", "Wire-free support", "Beautiful detailing", "Easy front wrap"], review: "\"Feels luxurious!\" — Fiona D." },
      { slug: "aerisoft", name: "AeriSoft", price: "19.99", url: "https://bragoddess.com/aerisoft", usps: ["Airy soft mesh fabric", "Wire-free comfort", "Lightweight design", "Sweat-free breathability"], review: "\"Like wearing a cloud!\" — Ruth A." },
      ...
      { slug: "ellebloom", name: "ElleBloom", price: "16.99", url: "https://bragoddess.com/ellebloom", usps: ["Blooming comfort style", "Soft breathable fabric", "All-day wear", "Senior-friendly comfort"], review: "\"Love the design!\" — Lorraine C." },
      { slug: "curvylace", name: "CurvyLace", price: "19.99", url: "https://bragoddess.com/curvylace", usps: ["Curvy fit design", "Beautiful lace overlay", "All sizes welcome", "Ultimate wire-free lift"], review: "\"Made for my shape!\" — Marge R." },
      { slug: "lunahug", name: "LunaHug", price: "19.99", url: "https://bragoddess.com/lunahug", usps: ["Luna gentle support", "Hugging comfort", "Soft stretch fabric", "Bold curve shaping"], review: "\"Gentle and supportive!\" — Luna K." },
      { slug: "senobra", name: "Senobra", price: "14.99", url: "https://bragoddess.com/senobra", usps: ["Senior-comfort focused", "Extra-wide soft straps", "Easy front closure", "Gentle healthy-feel comfort"], review: "\"Designed for comfort!\" — Irene T." },
      { slug: "ivylift", name: "IvyLift", price: "16.99", url: "https://bragoddess.com/ivylift", usps: ["Seamless wire-free push-up", "Sculpt & define", "Lightweight feel", "Bold lift & curve shape"], review: "\"Never going back!\" — Nancy W." },
      ...
      { slug: "rosylift", name: "RosyLift", price: "22.99", url: "https://bragoddess.com/rosylift", usps: ["Best-selling custom lift", "Adjustable support", "Wire-free comfort", "Ultimate wire-free lift"], review: "\"My favourite!\" — Linda S." },
      { slug: "liftyglow", name: "LiftyGlow", price: "19.99", url: "https://bragoddess.com/liftyglow", usps: ["Flexi-lift comfy bra", "Flexible underwire-free", "Glowing comfort", "Customizable lift levels"], review: "\"Incredible lift!\" — Joyce B." },
      { slug: "evaglow-bra", name: "EvaGlow Bra", price: "16.99", url: "https://bragoddess.com/evaglowbra", usps: ["Seamless powerful lift", "Cleavage boost", "Breathable fabric", "Ultimate wire-free lift"], review: "\"Feels like nothing!\" — Rose C." },
      ...
      { slug: "curvyflex", name: "CurvyFlex", price: "22.99", url: "https://bragoddess.com/curvyflex", usps: ["Side smoothing support", "Wide comfort straps", "Soft roomy cups", "Secure bust shaping"], review: "\"Finally, a bra that actually supports.\" — Melissa" },
      ...
      { slug: "hanabra", name: "Hana Bra", price: "22.98", url: "https://bragoddess.com/hanabra", usps: ["Natural lift & smooth sides", "Buttonless comfy fit", "Bedtime-soft comfort", "Delicate comfy weave"], review: "\"Real support without the torture\" — Jill P" },
    ],
  },
  ...
  gents_lux: {
    ...
    defaultProductCount: 6,
    requiredProductSlugs: ["jettjeans", "icyshorts", "airflexion"],
    bodyHomepageLinkPolicy: "required",
    emojiPolicy: "yes",
    subjectDevices: [
      "open-loop",
      "pattern-interrupt",
    ...
    catalog: [
      { slug: "jettjeans", name: "JettJeans3", price: "32.99", hero: true, url: "https://gentslux.com/jettjeans", usps: ["4-way stretch denim", "Straight-fit classic look", "Deep functional pockets", "Easy movement comfort"], review: "\"Comfortable all day.\" — Terry D." },
      { slug: "icyshorts", name: "Icy Shorts", price: "18.98", url: "https://gentslux.com/icyshorts", usps: ["Ice silk cooling", "Quick-dry stretch", "All-day cool comfort", "Easy movement fit"], review: "\"Saved my summer!\" — Frank D." },
      ...
      { slug: "meshirons", name: "MeshIrons", price: "24.99", url: "https://gentslux.com/meshirons", usps: ["Breathable mesh panels", "Wrinkle-resistant fabric", "Easy care wash", "Ice silk comfort"], review: "\"Always looks pressed.\" — Carl M." },
      { slug: "easetactic", name: "EaseTactic", price: "26.99", url: "https://gentslux.com/easetactic", usps: ["Tactical ease design", "Stretch-flex waist", "Light & durable", "Built-to-endure comfort"], review: "\"Built for action.\" — James B." },
      { slug: "oldenease", name: "OldenEase", price: "26.95", url: "https://gentslux.com/oldenease", usps: ["Senior comfort focused", "No belt wrestling", "Gentle elastic waist", "All-day comfort"], review: "\"Finally pants that fit.\" — Harold P." },
      { slug: "stretchactive", name: "StretchActive", price: "22.99", url: "https://gentslux.com/stretchactive", usps: ["Super stretch 4-way", "Machine washable", "Casual to sport", "Freshness in motion"], review: "\"Stretches perfectly.\" — Dennis W." },
      { slug: "easeflexor", name: "EaseFlexor", price: "22.97", url: "https://gentslux.com/easeflexor", usps: ["Ease of movement", "Pull-on comfort waist", "All-day wear", "Easy freedom of movement"], review: "\"Move without restriction.\" — George K." },
      { slug: "multipants", name: "MultiPants", price: "29.99", url: "https://gentslux.com/multipants", usps: ["4-way stretch", "No-fuss design", "Multi-pocket storage", "Comfort in every move"], review: "\"Everything fits!\" — Harold B." },
      { slug: "airflexion", name: "AirFlexion", price: "29.99", url: "https://gentslux.com/airflexion", usps: ["Ice silk comfort", "Pull-on elastic waist", "Smart casual ease", "Premium woven feel"], review: "\"Step in, ready to go!\" — George P." },
      { slug: "easemotions", name: "EaseMotions", price: "32.99", url: "https://gentslux.com/easemotions", usps: ["Ease of motion design", "Stretch fabric", "Lightweight feel", "Freedom in every step"], review: "\"Moves with me all day.\" — Larry S." },
      { slug: "modenease", name: "ModenEase", price: "32.99", url: "https://gentslux.com/modenease", usps: ["Modern ease design", "Stretch waistband", "Smart casual look", "Refined comfort look"], review: "\"Modern and comfortable.\" — Steven H." },
      { slug: "stretchmotions", name: "StretchMotions", price: "29.99", url: "https://gentslux.com/stretchmotions", usps: ["Superb stretch", "Multi-pocket storage", "All-terrain wear", "Durable cargo comfort"], review: "\"Best pants I own!\" — Dennis W." },
      ...
      { slug: "glideactive", name: "GlideActive", price: "24.99", url: "https://gentslux.com/glideactive", usps: ["Active glide fit", "Quick-dry fabric", "Sport-casual design", "Timeless active style"], review: "\"Great for all activities.\" — Paul R." },
      { slug: "ice-strider", name: "IceStrider", price: "32.99", url: "https://gentslux.com/icestrider", usps: ["Soft-touch comfort", "Flexible easy fit", "Every-occasion style", "Long-lasting durability"], review: "\"Sharp and comfy.\" — Robert K." },
      ...
      { slug: "flexrover", name: "FlexRover", price: "29.99", url: "https://gentslux.com/flexrover", usps: ["10-inch flex waistband", "Durable cargo fabric", "Roomy deep-crotch fit", "Ultra-flex cargo fit"], review: "\"Great for hunting and outdoor activity\" — Keith" },
      { slug: "arcticmove", name: "ArcticMove", price: "23.99", url: "https://gentslux.com/arcticmove", usps: ["9°F instant cooling", "All-day arctic comfort", "Freedom to move", "Adjustable custom fit"], review: "\"Good everyday shorts\" — Brian" },
      { slug: "easetailor", name: "EaseTailor", price: "32.99", url: "https://gentslux.com/easetailor", usps: ["Tailored straight fit", "Effortless motion", "Cool-touch fabric", "Smart wardrobe polish"], review: "\"Great pants\" — Michael Hickman" },
    ],
  },
  ...
  lux_fitting: {
    ...
    freeShipThreshold: "40",
    defaultProductCount: 6,
    requiredProductSlugs: ["stretchactive-lf", "icy-shorts-lf", "softygrace"],
    bodyHomepageLinkPolicy: "required",
    emojiPolicy: "yes",
    subjectDevices: [
      "open-loop",
    ...
    catalog: [
      { slug: "stretchactive-lf", name: "StretchActive", price: "24.99", hero: true, url: "https://luxfitting.com/stretchactive", usps: ["Ultra-soft stretch", "Perfect drape fit", "Breezy summer comfort", "Simple practical pockets"], review: "\"Moves with me perfectly.\" — Sandra T." },
      { slug: "icy-shorts-lf", name: "Icy Shorts", price: "16.98", url: "https://luxfitting.com/icyshorts", usps: ["Ice silk cooling", "Quick-dry stretch", "Easy stretch waist", "Light breezy fit"], review: "\"No pinching at all!\" — Marissa T." },
      { slug: "airygrace", name: "AiryGrace", price: "26.99", url: "https://luxfitting.com/airygrace", usps: ["Elegant body drape", "Pure softness", "Pull-on comfort", "Any-occasion style"], review: "\"Feels so light!\" — Diane M." },
      { slug: "softygrace", name: "SoftyGrace", price: "29.99", url: "https://luxfitting.com/softygrace", usps: ["Silky pull-on waist", "Stretch comfort fit", "Premium woven feel", "All-day elegance"], review: "\"Wore it all day!\" — Linda R." },
      { slug: "glamorease", name: "GlamorEase", price: "24.99", url: "https://luxfitting.com/glamorease", usps: ["Perfect drape fit", "High-rise pull-on waist", "Stretch comfort", "Flattering easy style"], review: "\"Glamorous and easy!\" — Gloria P." },
      ...
      { slug: "flowycharm", name: "FlowyCharm", price: "29.99", url: "https://luxfitting.com/flowycharm", usps: ["Drapey wide-leg fit", "No-squeeze waistband", "FeatherWeave freshness", "Elegant high waist"], review: "\"So charming and comfortable!\" — Donna H." },
      ...
      { slug: "soraease", name: "SoraEase", price: "26.99", url: "https://luxfitting.com/soraease", usps: ["Soaring lightweight feel", "Breathable soft fabric", "All-day comfort", "Softness in every thread"], review: "\"Feels like nothing!\" — Norma C." },
      { slug: "ellaflow", name: "EllaFlow", price: "29.99", url: "https://luxfitting.com/ellaflow", usps: ["Ella flow drape fabric", "Elegant silhouette", "Breathable wear", "AirFlow fabric softness"], review: "\"Elegant and effortless!\" — Ella W." },
      { slug: "linenglam", name: "LinenGlam", price: "29.99", url: "https://luxfitting.com/linenglam", usps: ["Ultra-soft wide leg", "Graceful drape", "LinoWeave polish", "Unrestricted movement"], review: "\"So classy!\" — Beverly H." },
      ...
      { slug: "loragrace", name: "LoraGrace", price: "24.99", url: "https://luxfitting.com/loragrace", usps: ["Lora grace design", "Comfort waist", "Timeless style", "Graceful elegant shape"], review: "\"Grace in every step!\" — Laura N." },
      { slug: "ella-ease", name: "EllaEase", price: "34.99", url: "https://luxfitting.com/ellaease", usps: ["Gentle stretch", "Helps knee/leg movement", "Everyday comfort", "Slip-on comfort"], review: "\"My legs feel free!\" — Shirley D." },
      ...
      { slug: "easetrousers", name: "EaseTrousers", price: "19.99", url: "https://luxfitting.com/easetrousers", usps: ["High-rise elastic waist", "4-way stretch twill", "Tailored straight-leg drape"], review: "\"So worth it!\" — Krystal Mraz" },
      ...
      { slug: "icedactive", name: "IcedActive", price: "16.99", url: "https://luxfitting.com/icedactive", usps: ["Ice silk quick-dry", "Breeze-through comfort", "More room to move", "Convenient stretch design"], review: "\"Perfect for summer\" — Jessie H" },
    ],
  },
...
export function requiredProductSlugs(brandId: string): string[] {
  return getBrand(brandId).requiredProductSlugs || [];
}

export function requiredProducts(brandId: string): Brand["catalog"] {
  const brand = getBrand(brandId);
  const required = new Set(requiredProductSlugs(brandId));
  return brand.catalog.filter((product) => required.has(product.slug));
}

export function missingRequiredProducts(brandId: string, slugs: string[]): Brand["catalog"] {
  const present = new Set(slugs);
  return requiredProducts(brandId).filter((product) => !present.has(product.slug));
}

export function bodyHomepageLinkPolicy(brandId: string): NonNullable<Brand["bodyHomepageLinkPolicy"]> {
  return getBrand(brandId).bodyHomepageLinkPolicy || "allowed";
}
