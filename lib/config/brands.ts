...
export const BRANDS: Record<string, Brand> = {
  bra_goddess: {
    ...
    catalog: [
      { slug: "daisybra", name: "Daisy Bra", price: "12.99", hero: true, url: "https://bragoddess.com/daisybra", usps: ["Front button — no reaching behind", "U-shaped back stops strap slipping", "Moisture-wicking cotton blend", "Posture correction support"], review: "\"Forgot it's there!\" — Helen R." },
      { slug: "posybra", name: "Posy Bra", price: "19.99", url: "https://bragoddess.com/posybra", usps: ["Front closure for seniors", "Band 28–58, cup A–G sizing", "Full coverage, zero bulging", "Soft microfiber, 12 colours"], review: "\"My 2nd order!\" — Sharon M." },
  ...
  gents_lux: {
    ...
    catalog: [
      ...
      { slug: "airflexion", name: "AirFlexion", price: "29.99", url: "https://gentslux.com/airflexion", usps: ["COOLFLEX® ice silk feel", "360° Adaptive Waistband", "No belt, pull-on ease", "Smart casual all-day wear"], review: "\"Step in, ready to go!\" — George P." },
  ...
  lux_fitting: {
    ...
    catalog: [
      { slug: "stretchactive-lf", name: "StretchActive", price: "24.99", hero: true, url: "https://luxfitting.com/stretchactive", usps: ["COOLMAX® moisture-wicking stretch", "360° stretch, keeps its shape", "2 waterproof zipper pockets", "Wrinkle/fade/pill resistant"], review: "\"Moves with me perfectly.\" — Sandra T." },
      { slug: "icy-shorts-lf", name: "Icy Shorts", price: "16.98", url: "https://luxfitting.com/icyshorts", usps: ["Ice silk cooling, quick-dry", "360° stretch up to 8x", "Secure zipper pockets", "Universal fit XXS–5XL"], review: "\"No pinching at all!\" — Marissa T." },
      ...
      { slug: "softygrace", name: "SoftyGrace", price: "29.99", url: "https://luxfitting.com/softygrace", usps: ["Airflow® 100% stretch polyester", "High-rise pull-on, no squeeze", "Soft as loungewear, styled for everywhere", "Designed for women 50+"], review: "\"Wore it all day!\" — Linda R." },
